...
from .exceptions import IsilonLibraryError
...
class Platform(object):
    ...
    def snapshot_delete(self, name, **kwargs):
        ...
        if name == "":
            ...
            raise IsilonLibraryError(
                "Empty name field for snapshot delete, use snapshot_delete_all to delete all snaps")
    ...
    def quota_create(self, name, path, **kwargs):
        '''Create quota'''
        data = self._override({'name': name, 'path': path}, kwargs)
